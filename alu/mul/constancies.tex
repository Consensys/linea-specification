...
\end{itemize}
\end{multicols}
\noindent Note that $\tinyExponent$, $\tinyBase$, $\oli$ and $\resVanishes$ are automatically stamp-constant seeing as they are directly derived from imported columns (see section~\ref{alu: mul: tiny base, tiny exponent, oli and result vanishes binary columns}.)
