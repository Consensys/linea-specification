Let $y$ be an integer in the range $\big[\!\!\!\:\big[-2^{255}, 2^{255}\big[\!\!\!\:\big[$. Recall that under \emph{overflow semantics} its negative $y.\col{Neg()}\in \big[\!\!\!\:\big[-2^{255}, 2^{255}\big[\!\!\!\:\big[$ is defined as follows: % \footnote{\ob{TODO: reference the \inst{SDIV} specification of the yellow paper}}
\[
	\begin{cases}
