We suggest the reader start with the chapter on the \textbf{hub}~(\ref{chap: hub}).
...
In our design the RAM is split into 2 pieces: the memory management unit~(\ref{chap: mmu}) (or offset processor) and the memory mapped input output module(\ref{chap: ram}).
