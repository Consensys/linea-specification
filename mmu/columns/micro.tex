...
\end{enumerate}
Examples of the above include \inst{CREATE2}'s or byte code deployments through \inst{RETURN} which simultaneously ship initialization code to the \romMod{} and \kecMod{} modules.
