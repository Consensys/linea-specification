		...
		\begin{description}
			\item[\underline{Micro-instruction:}]
				...
				\]
					where we set
					\begin{enumerate}
						\item \If $\locFastLastLimb = 1$ \Then
							\[
								\locLastMicroInst \define \mmioInstRamToRamTransplant
							\]
						\item \If $\locFastLastLimb = 0$ \Then
							\begin{enumerate}
								\item \If $\locLastLimbSingleSource = 1$ \Then
									\[
										\locLastMicroInst \define \mmioInstRamToRamPartial
									\]
								\item \If $\locLastLimbSingleSource = 0$ \Then
									\[
										\locLastMicroInst \define \mmioInstRamToRamTwoSource
									\]
							\end{enumerate}
					\end{enumerate}
		\end{description}
