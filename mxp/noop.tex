...
We further settle the expected behaviour in case of a (from the point of view of the memory expansion module) \col{noop}. No memory expansion happens, memory size remains the same. The associated  constraints are thus:
\begin{enumerate}
	\item \If $\noop_{i} = 1$ \Then
\[
	\left\{
