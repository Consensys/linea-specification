...
see section~(\ref{rlp txn: phase constraints: access list: countdowns}) and
note~(\ref{rlp txn: phase constraints: access list: countdowns: non counter constancy of access list RLP length}).
