...
\begin{enumerate}[resume]
	\item \If $\locAuthorizationData        _{i} = 1$ \Then $\locAuthorizationLengthCountdown _{i} = \locAuthorizationLengthCountdown _{i - 1} - \lc _{i} \cdot \rlpTxnComputationColumnLimbSize _{i}$
	\item \If $\locAuthorizationNotFirstRow _{i} = 1$ \Then $\locAuthorizationItemCountdown   _{i} = \locAuthorizationItemCountdown   _{i - 1} - \lc _{i} \cdot \rlpTxnComputationColumnLimbSize _{i}$
\end{enumerate}
...
\begin{enumerate}[resume]
	\item \If $\locAuthorizationFirstRow _{i} = 1$ \Then:
		\begin{enumerate}
			\item an authorization is $\locAuthorizationNumberOfRows$ row long: $\locAuthorizationIndex _{i + \locAuthorizationNumberOfRows - 1} = \locAuthorizationIndex _{i}$
	...
	\begin{enumerate}
		\item
			\If   $\rlpTxnCommonColumnNumberOfAuthorization \neq \locAuthorizationIndex _{i} + 1 $
