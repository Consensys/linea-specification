...
| ⟦OOB_INST_bls12_*⟧        |            |            |               | . ∧ [cds is valid]        | . (if hub_success ≡ true)     | .   ∧ [cds ≠ 0]            | .   ∧ [cds = 0]            |                            |            |
|                           |            |            |               |                           |                               |                            |                            |                            |            |
|                           | ✓ trusted  | ✓ trusted  | ✓ trusted     | ⟦ π ⟧                     | ⟦ π ⟧                         | ⟦ π ⟧                      | ⟦ π ⟧                      | ⟦ π ⟧                      |            |
|---------------------------+------------+------------+---------------+---------------------------+-------------------------------+----------------------------+----------------------------+----------------------------+------------|
|---------------------------+------------+------------+---------------+---------------------------+-------------------------------+----------------------------+----------------------------+----------------------------+------------|
...
- [cds is valid] is a placeholder for the validity of cds and it is instruction dependent:
        ...
        * ⟦OOB_INST_pointevaluation⟧, ⟦OOB_INST_bls12_g1add⟧, ⟦OOB_INST_bls12_g2add⟧, ⟦OOB_INST_bls12_map_fp_to_g1⟧, ⟦OOB_INST_bls12_map_fp2_to_g2⟧: [cds = fixed_size] where fixed_size = 192, 256, 512, 64, 128 respectively  
