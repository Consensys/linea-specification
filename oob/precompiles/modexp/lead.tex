...
The \inst{MODEXP} computes the $\lfloor \log_{2} ( \cdots ) \rfloor$ of this in order to deduce what the \cite{EYP-London} calls $\locExponentLogEYP$.
\[
