...
\begin{description}
	...
	\item[\underline{Justifying some \hubMod{} predictions:}]
		...
		\[
			\left\{ \begin{array}{lcl}
				\locExtractCallData & = & \locHubSuccess \cdot \locCallDataExtractionFilter \cdot (1 - \locCdsIsZero) \\
				\locEmptyCallData   & = & \locHubSuccess \cdot \locCallDataExtractionFilter \cdot \locCdsIsZero       \\
