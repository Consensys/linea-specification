...
\begin{multicols}{3}
	\begin{itemize}
		...
		\item \inst{IDENTITY}
		\item \inst{ECPAIRING}.
		\item \inst{BLS12\_G1ADD}
        \item \inst{BLS12\_G1MSM}
        \item \inst{BLS12\_G2ADD}
        \item \inst{BLS12\_G2MSM}
        \item \inst{BLS12\_PAIRING\_CHECK}
        \item \inst{BLS12\_MAP\_FP\_TO\_G1}
        \item \inst{BLS12\_MAP\_FP2\_TO\_G2}
		\item[\vspace{\fill}]
	\end{itemize}
\end{multicols}
