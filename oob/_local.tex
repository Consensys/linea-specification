...
\def\locPairingSize                     {\redm{192}}
\def\locGasCostPairingBaseName          {G_\text{pairingbase}}
\def\locGasCostPairingPairName          {G_\text{pairingpair}}
\def\locGasCostPairingBase              {\redm{45000}}
\def\locGasCostPairingPair              {\redm{34000}}
\def\locEcrecoverGasCost                {\col{ecrecover\_cost}}
\def\locEcaddGasCost                    {\col{ecadd\_cost}}
\def\locEcmulGasCost                    {\col{ecmul\_cost}}
\def\locGasCostEcrecover                {\redm{3000}}
\def\locGasCostEcadd                    {\redm{150}}
\def\locGasCostEcmul                    {\redm{6000}}

\def\locGasCostShaTwoName               {G_\text{sha2base}}
\def\locGasCostRipemdName               {G_\text{ripebase}}
\def\locGasCostIdentityName             {G_\text{idbase}}
\def\locGasCostShaTwo                   {\redm{60}}
\def\locGasCostRipemd                   {\redm{600}}
\def\locGasCostIdentity                 {\redm{15}}

\def\locGasCostShaTwoWordName           {G_\text{sha2word}}
\def\locGasCostRipemdWordName           {G_\text{ripeword}}
\def\locGasCostIdentityWordName         {G_\text{idword}}
\def\locGasCostShaTwoWord               {\redm{12}}
\def\locGasCostRipemdWord               {\redm{120}}
\def\locGasCostIdentityWord             {\redm{3}}

\def\locShaTwoCost                      {\col{sha2\_cost}}
\def\locRipemdCost                      {\col{ripemd\_cost}}
\def\locIdentityCost                    {\col{identity\_cost}}

% \def\locGasCostIdentityName             {G_\text{}}
% \def\locGasCostShaTwo                   {\redm{}}
