...
\def\locPrcName                         {\col{prc\_name}}
\def\locNumInp                          {\col{num\_inp}}
%
...
\def\locBlsPairingSizeIsMultiple        {\col{is\_multiple\_of\_bls\_pairing\_check\_size}}
\def\locNumberOfInputs                  {\col{num\_inputs}}
\def\locNumberOfMsmInputsGtThreshold    {\locNumberOfInputs\col{\_gt\_128}}
\def\locNumberOfMsmInputsLeqThreshold   {\locNumberOfInputs\col{\_leq\_128}}
...
% XCREATE
\def\locMaxInitCodeSizeException        {\col{maxcsx}}
\def\locNoMaxInitCodeSizeException      {\col{no\_maxcsx}}
\def\locInitCodeSizeHi                  {\col{init\_code\_size\_hi}}
\def\locInitCodeSizeLo                  {\col{init\_code\_size\_lo}}
\def\locExceedsMaxInitCodeSize          {\col{exceeds\_max\_init\_code\_size}}
% CREATE
...
% lookup shorthands
\def\locLookupFlagSum                   {\col{lookup\_flag\_sum}}
\def\locLookupWeightedSum               {\col{lookup\_wght\_sum}}
...
\def\locDiscount                        {\col{discount}}
\def\locMaxDiscount                     {\col{max\_discount}}
\def\locMsmMultiplicationCost           {\col{msm\_multiplication\_cost}}