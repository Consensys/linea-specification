...
\[
	...
	\end{array} \right.
\]
\saNote{} In the above we use the notation $\oxXcall$, $\oxCall$, $\oxXcreate$, $\oxCreate$, $\oxEcrecover$, \dots, $\oxBlakeParams$ as \textbf{placeholders} for some actual, fixed values.
