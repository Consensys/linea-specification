...
\[
	\left\{ \begin{array}{lcl}
		...
		\end{array} \right] \vspace{2mm} \\
		\locFlagSumEipBlobTransactions_{i} & \define & \oobInstIsPointEvaluation_{i} \\
		\vspace{2mm} \\
...
\[
	...
	\left\{ \begin{array}{lcl}
		...
		\end{array} \right] \vspace{2mm} \\
		\weightedPrcEipBlobTransactions_{i} & \define & \oobInstPointEvaluation \cdot \oobInstIsPointEvaluation _{i} \\
		\vspace{2mm} \\
...
\[
	...
	\left\{ \begin{array}{lcl}
		...
		\end{array} \right] \vspace{2mm} \\
		\maxCtFlagSumPrcEipBlobTransactions_{i} & \define & \oobCtMaxPointEvaluation \cdot \oobInstIsPointEvaluation _{i} \\
	    \vspace{2mm} \\
