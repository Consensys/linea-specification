...
\begin{description}
	\item[\underline{\inst{ECRECOVER}, \inst{SHA2-256}, \inst{RIPEMD-160}, \inst{IDENTITY}, \inst{ECADD}, \inst{ECMUL}, \inst{ECPAIRING},\inst{BLS12\_G1ADD}, \inst{BLS12\_G2ADD}, \inst{BLS12\_MAP\_FP\_TO\_G1}, \inst{BLS12\_MAP\_FP2\_TO\_G2}:}]
	detect both $\cds \equiv 0$ and $\rac \equiv 0$; 
	\item[\underline{\inst{ECRECOVER}, \inst{ECADD} and \inst{ECMUL}:}]
