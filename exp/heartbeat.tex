...
% \saNote{} The heartbeat imposes in particular that if $\expStamp_{i} = 0$ the exponent is zero as is the dynamic cost. This is compatible with \inst{EXP}'s dynamic pricing model.
