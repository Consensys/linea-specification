...
\begin{enumerate}[resume]
	\item $\gasActual$: \godGiven{};
		\ccc{}; amount of gas available to the execution context just prior to dealing with the current \inst{CALL}-type or \inst{CREATE}-type instructions;
	...
	\item $\gasPoop$: \godGiven{};
		\ccc{}; gas amount ``paid out of pocket'' from the remaining gas of the
		\callerName{}/\creator{} to the
		\calleeName{}/\createe{};
