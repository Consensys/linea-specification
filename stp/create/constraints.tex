...
The present section defines the layout of the data to be used in the lookups to the \wcpMod{} and \modMod{} for \inst{CREATE}-type instructions. The resulting values of the computation are sufficient to justify the \gasStipend{} column. We refer the reader to the explanation and diagrams from section~(\ref{stp: create: representation})
\begin{description}
...
\[
	\boxed{\text{The constraints below further assume that } \locOogx = 0.}
\]
\begin{description}
