...
\includepdf[fitpaper=true, pages={1}]{lua/extraction_for_keccak___pre_verticalization.pdf}
\includepdf[fitpaper=true, pages={1}]{lua/extraction_for_keccak___verticalized.pdf}
\includepdf[fitpaper=true, pages={1}]{lua/extraction_for_keccak___prover_columns.pdf}
