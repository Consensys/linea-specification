        ...
        \resizebox{13cm}{!}{%
            \[
                \begin{array}{|c|c|c|c|c|c|c|c|c|} \hline
                    ...
                    4                         & \hdots                           & \hdots                             & \hdots                 & 0                   & \hdots                               & 0                            & \hdots               & \hdots                                                                                                                                                       \\ \hline
                    ...
                    7                         & 0                                & 1                                  & 0                      & 0                   & \hdots                               & 0                            & \locPairingsResultHi & \hdots                                                                                                                                                       \\ \hline
                    7                         & 0                                & 1                                  & \redm{1}               & 0                   & \hdots                               & 0                            & \locPairingsResultLo & \hdots                                                                                                                                                       \\ \hline
                \end{array}
            \]
        }
    \end{adjustwidth}
    \caption{Behaviour of \hurdle ~ in the context of a call to \instEcpairing{}, with 2 pairings. The different background colors emphasise the rows corresponding to the different pairings. For each pairing, the corresponding constraints are defined considering its first row as $i$. For each pairing after the first one, $\locPreviousInternalChecksPassed$ is used to compute $\locInternalChecksPassed$.}
\end{figure}
...
\begin{figure}[h!]
    \[
        ...
        \begin{array}{|c|c|c|c|c|c|c|}
            ...
            18                        & 1                                      & 0                                        & \redm{9}               & \locQYLo             & \locInternalChecksPassed = \locROneMembership \cdot \hurdle_{i+2}                           \\ \hline
...
% TODO: complete P256VERIFY table and make tables fit
