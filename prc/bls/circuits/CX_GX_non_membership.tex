...
\begin{enumerate}
    \item \If $\malformedDataExternalJustification_{i} = 1$ \Then
        \begin{enumerate}
            ...
            \item $(\cOneMembershipTestRequired _{i} + \gOneMembershipTestRequired _{i}) \cdot \isFirstInput + (\cTwoMembershipTestRequired _{i} + \gTwoMembershipTestRequired _{i}) \cdot \isSecondInput = \malformedDataBit_{i}$ % TODO: check this
