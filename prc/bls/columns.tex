...
\begin{enumerate}[resume]
      ...
      \item \both{\malformedDataBit} \blsPrediction{}: binary columns, constant for a given point, which lights up when that point does not belong to the expected field; % counter-constant           
      ...
      % TODO: double check if this description is accurate
