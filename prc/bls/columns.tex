...
\begin{enumerate}
    ...
    \item
        ...
        \inst{\prcNameBlsGOneMsm},
        \inst{\prcNameBlsGTwoMsm} and
        \inst{\prcNameBlsPairingCheck};
    \item
        \hubMmuMmioBlsInput{}
        \blsIndex{}:
        data limb index;
...
\begin{enumerate}[resume]
    ...
    \item
        \accInputs:
        In the context of \inst{\prcNameBlsGOneMsm}, \inst{\prcNameBlsGTwoMsm} and \inst{\prcNameBlsPairingCheck}, counts the inputs starting from 1. It is equal to 0 otherwise.
    \item
        $\byteCol{$\Delta$}$:
...
(\emph{c}) those raising \wellformedDataTrivial{}, which are \inst{\prcNameBlsPairingCheck}-calls such that every pair of points is wellformed and containts at least one point at infinity;
...
\begin{enumerate}[resume]
    ...
    \item
        ...
        \ccbc{};
        lights up along malformed curve or subgroup points or externally invalid \inst{\prcNamePointEvaluation} input rows;
    \item
    ...
    \item
        ...
        binary column, constant for a given \blsId, which lights up when the data is well formed in the case of \inst{\prcNameBlsPairingCheck}-calls known to be trivial;
    \item
...
\inst{\prcNameBlsGOneAdd},
\inst{\prcNameBlsGOneMsm},
\inst{\prcNameBlsGTwoAdd},
\inst{\prcNameBlsGTwoMsm},
\inst{\prcNameBlsPairingCheck}
precompiles.
\begin{enumerate}[resume]
    \item
