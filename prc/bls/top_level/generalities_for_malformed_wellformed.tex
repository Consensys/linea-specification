...
\malformedDataInternalJustification{}, \malformedDataExternalJustification{}, \wellformedDataTrivial{}, \wellformedDataNontrivial{}
...
\begin{enumerate}[resume]
    \item
        ...
        \If $\locIsBlsMapFpToGOne    _{i} = 1$ \Then $\malformedDataExternalJustification _{i} = 0$
    \item
        \label{bls: top level: hash to G2 cannot throw MEXT}
        \If $\locIsBlsMapFpTwoToGTwo _{i} = 1$ \Then $\malformedDataExternalJustification _{i} = 0$
    \item
