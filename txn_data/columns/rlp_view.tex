...
\begin{enumerate}[resume]
	...
	% \item
	% 	$\txnDataRlpLengthOfDelegationList$:
	% 	number of account delegations for \cite{EIP-7702} transactions;
	% \item
	% 	\txnDataNumberOfSuccessfulSenderDelegations{}
	%	DEPRECATED: this is counted in the HUB
	% \item
	% 	\txnDataRlpChainId{}
