...
\[
	\left\{ \begin{array}{lcl}
		...
		\locRlpMaxFeePerBlob         & \define & \txnDataRlpMaxFeePerBlob			      _{i + \rlpViewRowOffset} \vspace{1mm} \\
		\locRlpNumberOfBlobs         & \define & \txnDataRlpNumberOfBlobs			      _{i + \rlpViewRowOffset} \vspace{1mm} \\
