...
\begin{description}
	...
	\item[\underline{Marking transactions following \cite{EIP-1559} gas semantics:}]
		...
		\]
	\item[\underline{Transferring the length of the authorization list:}]
		we impose
		\[
			\txnDataRlpLengthOfDelegationList _{i + \rlpViewRowOffset} = \txnDataHubLengthOfDelegationList _{i + \hubViewRowOffset}
		\]
