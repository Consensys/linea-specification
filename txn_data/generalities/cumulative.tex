...
The present section constrains $\cumulativeConsumedGas$ and $\cumulativeConsumedBlobGas$ columns.
...
\begin{enumerate}
	\item
		$\cumulativeConsumedGas$ and $\cumulativeConsumedBlobGas$ are counter-constant
	\item
		\label{user txn data: generalities: cumulative gas: cumulative gas is zero outside of user transactions}
		\If $\user _{i} = \false$ \Then $\cumulativeConsumedGas _{i} = $\cumulativeConsumedBlobGas$= 0$
	\item
