...
\end{enumerate}
Recall that the \textbf{intrinsic gas (cost)} is ``the amount of gas this transaction requires to be paid prior to execution'' \ob{TODO: add reference ot EYP, page 9}.
