...
\def\locCtMaxTrivialOperation              {\yellowm{1}}
\def\locCtMaxMxpx                          {\yellowm{2}}
\def\locCtMaxMsize                         {\yellowm{3}}
\def\locCtMaxFixedSizeInstructions         {\yellowm{4}}
\def\locCtMaxSingleMaxOffsetAndWordPricing {\yellowm{5}}
\def\locCtMaxSingleMaxOffsetAndBytePricing {\yellowm{6}}
\def\locCtMaxDoubleMaxOffsetAndWordPricing {\yellowm{7}}
\def\locCtMaxDoubleMaxOffsetAndBytePricing {\yellowm{8}}
