The constraints below construct (the high and low parts of) the \romColumnPushValue{} for \inst{PUSH} instructions. We start by describing the ``non push data'' case:
