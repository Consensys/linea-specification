The \textbf{block data} module \btcMod{} is a repository for data which relates to the batch of transactions and which may find itself loaded into the stack.
