...
First of all we recall that, in the
\zkEvm{} in general, and in this module in particular, transactions are identified with their absolute transaction number
