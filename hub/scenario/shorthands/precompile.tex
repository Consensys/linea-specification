...
\[
	...
	\left[ \begin{array}{l}
		...
		% % uncomment for BLS
		% + \scenBlsGoneAdd      _{i} \\ % common ? % % uncomment for BLS ?
		% + \scenBlsGoneMsm      _{i} \\ % common ?
		% + \scenBlsGtwoAdd      _{i} \\ % common ?
		% + \scenBlsGtwoMsm      _{i} \\ % common ?
		% + \scenBlsPairingCheck _{i} \\ % common ?
		% + \scenBlsMapFpToGone  _{i} \\ % common ?
		% + \scenBlsMapFpToGtwo  _{i} \\ % common ?
	\end{array} \right]
\]
% % uncomment for BLS
...
\[
	...
	\left[ \begin{array}{l}
		...
		% + \; \mathtt{0x\,0b} \cdot \scenBlsGoneAdd      _{i} \\ % % uncomment for BLS
