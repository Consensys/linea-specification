\begin{center}
	\boxed{\text{All constraints in this subsection assume that $\txInit _{i} = 1$ and $\peekMisc _{i} = 1$.}}
\end{center}
...
\begin{description}
		\input{tx_init/peeking/will_revert}
		\input{tx_init/peeking/wont_revert}
\end{description}
\saNote{}
