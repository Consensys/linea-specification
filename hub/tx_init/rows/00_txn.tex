			...
			\[
				\left\{ \begin{array}{lcl}
					...
					\left[ \begin{array}{cl}
						...
						+ & \locRecipientIsDelegatedAndDelegateHasNonemptyCode \\
						% + & \locRecipientIsDelegatedAndDelegateHasNonemptyCodeAndIsntDelegated \\
					\end{array} \right]
					\vspace{2mm} \\
					...
					\end{array} \right]
					\vspace{2mm} \\
					\locRecipientIsDelegatedAndDelegateHasNonemptyCode & \define &
					\left[ \begin{array}{cl}
						% \cdot & \locRecipientHasNonemptyCode \\
					...
					\end{array} \right]
					% \vspace{2mm} \\
					% \locRecipientIsDelegatedAndDelegateHasNonemptyCodeAndIsntDelegated & \define &
					% \left[ \begin{array}{cl}
					% 	% \cdot & \locRecipientHasNonemptyCode \\
					% 	\cdot & \locRecipientIsDelegated     \\
					% 	\cdot & \locDelegateHasNonemptyCode  \\
