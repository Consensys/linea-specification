...
If $\authAuthorityEcrecoverSuccess \equiv \true$ the following line is a $\peekAccount$-row, otherwise processing stops.
Assuming $\authAuthorityEcrecoverSuccess \equiv \true$, the account-row that follows is made to contain the authority address' account.
