...
\begin{enumerate}[resume]
	...
	% \item \scenBlsGoneAdd:      binary column; lights up whenever the \zkEvm{} is about to deal with the memory operations pertaining to the \texttt{BLS\_G1ADD}           precompile;
	% \item \scenBlsGoneMsm:      binary column; lights up whenever the \zkEvm{} is about to deal with the memory operations pertaining to the \texttt{BLS\_G1MSM}           precompile;
	% \item \scenBlsGtwoAdd:      binary column; lights up whenever the \zkEvm{} is about to deal with the memory operations pertaining to the \texttt{BLS\_G2ADD}           precompile;
	% \item \scenBlsGtwoMsm:      binary column; lights up whenever the \zkEvm{} is about to deal with the memory operations pertaining to the \texttt{BLS\_G2MSM}           precompile;
	% \item \scenBlsPairingCheck: binary column; lights up whenever the \zkEvm{} is about to deal with the memory operations pertaining to the \texttt{BLS\_PAIRING\_CHECK}  precompile;
	% \item \scenBlsMapFpToGone:  binary column; lights up whenever the \zkEvm{} is about to deal with the memory operations pertaining to the \texttt{BLS\_MAP\_FP\_TO\_G1} precompile;
	% \item \scenBlsMapFpToGtwo:  binary column; lights up whenever the \zkEvm{} is about to deal with the memory operations pertaining to the \texttt{BLS\_MAP\_FP\_TO\_G2} precompile;
\end{enumerate}
