...
\begin{enumerate}[resume]
	...
	\item \scenBlsMapFpToGtwo:  binary column; lights up whenever the \zkEvm{} is about to deal with the memory operations pertaining to the \inst{BLS\_MAP\_FP\_TO\_G2} precompile;
\end{enumerate}
