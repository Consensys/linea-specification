...
(\emph{b}) deploying nonempty bytecode requires reading data from \textsc{ram} and sending it both to the \romMod{} module for (temporary) deployment and to the \hashDataMod{} module
