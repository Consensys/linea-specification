...
Indeed, one of its purposes is to justify storage values that exist in the state for \inst{SLOAD} and \inst{SSTORE} instructions.
Yet some cases don't require the value \emph{per se} (e.g. exceptional \inst{SLOAD} instructions.)
