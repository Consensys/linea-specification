...
\begin{description}
	...
	\item[\underline{\underline{Repeat account encounter:}}] 
						...
						\item
							\[
								...
								\left\{ \begin{array}{lcl}
									\locAccFullAddress _{i} & = & \locAccFullAddress_{i - 1} \\
									\order{\relBlockNum}_{i} & = & \order{\relBlockNum}_{i - 1}
								\end{array} \right\}
		...
		(\ref{hub: consistency: account: first and final: transaction}) into a single constraint.
