			...
			\item[\underline{Setting module flags:}]
				...
				\[
					\left\{ \begin{array}{lclr}
						\miscExpFlag_{i + \locCopyMiscRowOffset} & = & \gZero         \\
						\miscMmuFlag_{i + \locCopyMiscRowOffset} & = & \locTriggerMmu \\
						\miscMxpFlag_{i + \locCopyMiscRowOffset} & = & \locTriggerMxp \\
						\miscOobFlag_{i + \locCopyMiscRowOffset} & = & \locTriggerOob \\
						\miscStpFlag_{i + \locCopyMiscRowOffset} & = & \gZero         \\
					\end{array} \right.
				\]
				\saNote{}
				We will specify \locTriggerMmu{}, \locTriggerMxp{} and \locTriggerOob{} shortly.

				\saNote{} \label{hub: instruction handling: logs: constraints: optimized misc flags}
				One may slightly reduce the number of constraints above by imposing instead
				\[
					\left\{ \begin{array}{lcl}
						\left[ \begin{array}{clcl}
							+ & \miscExpWeight & \cdot & \miscExpFlag _{i + \locCopyMiscRowOffset} \\
							% + & \miscMmuWeight & \cdot & \miscMmuFlag _{i + \locCopyMiscRowOffset} \\
							+ & \miscMxpWeight & \cdot & \miscMxpFlag _{i + \locCopyMiscRowOffset} \\
							+ & \miscOobWeight & \cdot & \miscOobFlag _{i + \locCopyMiscRowOffset} \\
							+ & \miscStpWeight & \cdot & \miscStpFlag _{i + \locCopyMiscRowOffset} \\
						\end{array} \right]
						& = &
						\left[ \begin{array}{clcl}
					...
					% OK
				\]
				Indeed, by their very definitions, both
