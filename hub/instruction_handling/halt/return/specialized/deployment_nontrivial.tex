% \locSecondMiscRowOffsetDeployAndHash
% \locNonemptyDeploymentFirstAccountRowOffset 
% \locNonemptyDeploymentSecondAccountRowOffset
% \locCallerContextRowOffsetNonemptyDeploymentWillRevert
% \locCallerContextRowOffsetNonemptyDeploymentWontRevert
\begin{center}
	\boxed{%
...
\begin{description}
	...
	\item[\underline{Setting the (second) \mmuMod{} instruction:}]
		...
		\[
			...
			% \setMmuInstructionParametersRamToExoWithPadding {i}{\locSecondMiscRowOffsetDeployAndHash}
			% \left[ \begin{array}{ll}
			% 	\utt{Source ID:}            & \cn_{i}                                                    \\
			% 	\utt{Target ID:}            & \accCfi _{i + \locNonemptyDeploymentFirstAccountRowOffset} \\
			...
			% 	\utt{Exo sum:}              & \exoWeightRom + \exoWeightKec                              \\
			% 	\utt{Phase:}                & \nothing                                                   \\
			% \end{array} \right]
		\]
		\saNote{}
