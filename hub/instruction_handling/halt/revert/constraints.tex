			...
			\item
				...
				\begin{enumerate}
					...
					\item we impose that
						...
						\]
						\saNote{}
						We refer the reader to the interpertation of the above (and its meaninglessness) in case the current context is the root context of the transaction to section~(\ref{hub: consistencies: context: constraints}).
