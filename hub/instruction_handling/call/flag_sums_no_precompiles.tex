...
\begin{description}
	\item[\underline{Standard and extended \inst{CALL} flag prefixes:}]
		...
		For context,
		\begin{itemize}
			\item account-row $n°(i + \callFirstCallerAccountRowOffset           )$ pertains to the \callerName{}                    \atDoingTime{}
			\item account-row $n°(i + \callFirstCalleeAccountRowOffset           )$ pertains to the \calleeName{}                    \atDoingTime{}
			\item account-row $n°(i + \callFirstDelegateOrCalleeAccountRowOffset )$ pertains to the \delegateName{} or \calleeName{} \atDoingTime{}
		\end{itemize}
	...
	\item[\underline{Aborted call, caller context will revert:}]
		...
		For context,
		\begin{itemize}
			\item account-row $n°(i + \callSecondCalleeAccountRowOffsetAbortWillRevert           )$ pertains to the \calleeName{}                    \atRevertTime{}
			\item account-row $n°(i + \callSecondDelegateOrCalleeAccountRowOffsetAbortWillRevert )$ pertains to the \delegateName{} or \calleeName{} \atRevertTime{}
		\end{itemize}
	...
	\item[\underline{(Successful) call to Externally Owned Account, caller context will revert:}]
		...
		For context,
		\begin{itemize}
			\item account-row $n°(i + \callSecondCallerAccountRowOffset           )$ pertains to the \callerName{}                    \atRevertTime{},
			\item account-row $n°(i + \callSecondCalleeAccountRowOffset           )$ pertains to the \calleeName{}                    \atRevertTime{},
			\item account-row $n°(i + \callSecondDelegateOrCalleeAccountRowOffset )$ pertains to the \delegateName{} or \calleeName{} \atRevertTime{},
		\end{itemize}
	...
	\item[\underline{Smart contract call failure, caller context will revert:}]
		...
		For context,
		\begin{itemize}
			\item account-row $n°(i + \callSecondCallerAccountRowOffset          )$ pertains to the \callerName{}                        \atFailureTime{}
			\item account-row $n°(i + \callSecondCalleeAccountRowOffset          )$ pertains to the \calleeName{}                        \atFailureTime{}
			\item account-row $n°(i + \callThirdCalleeAccountRowOffset           )$ pertains to the \calleeName{}                        \atRevertTime{}
			\item account-row $n°(i + \callThirdDelegateOrCalleeAccountRowOffset )$ pertains to the \delegateName{} or the \calleeName{} \atRevertTime{}
		\end{itemize}
