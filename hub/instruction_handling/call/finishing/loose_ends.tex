...
\begin{itemize}
	...
	\item the parameter set $\childFrameInitializationParameters$ is defined in section~(\ref{hub: instruction handling: call: specialized: callee context parameters definition})
\end{itemize}
