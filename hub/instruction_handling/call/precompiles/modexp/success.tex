...
(\emph{e}) potentially copy part of the output to the current execution context's \textsc{ram}.

\saNote{}
In the present scenario ($\scenPrcSuccess _{i} \equiv 1$)
the normalized \locXbsNormalized{} coincide with the
un-normalized lo-parts \locXbsLo{}'s.
We consistently use \locXbsNormalized{}'s in this section.
\begin{description}
						...
						\item \If $\locExtractExponent = 1$ \Then
							\[
								\setMmuInstructionParametersModexpData {
									...
									sourceId        = \cn _{i}                                  ,
									targetId        = 1 + \hubStamp _{i}                        ,
									sourceOffsetLo  = 96 + \locBbsNormalized                    ,
									size            = \locEbsNormalized                         ,
									referenceOffset = \locPrcCdo                                ,
									referenceSize   = \locPrcCds                                ,
									phase           = \phaseModexpExponent                      ,
								}
				...
				\item[\underline{Setting the \mmuMod{} instruction:}]
					...
					\[
						\setMmuInstructionParametersModexpData {
							...
							sourceId        = \cn _{i}                                    ,
							targetId        = 1 + \hubStamp _{i}                          ,
							sourceOffsetLo  = 96 + \locBbsNormalized + \locEbsNormalized  ,
							size            = \locMbsNormalized                           ,
							referenceOffset = \locPrcCdo                                  ,
							referenceSize   = \locPrcCds                                  ,
				...
				\item[\underline{Setting the \mmuMod{} instruction:}]
					...
					\[
						\setMmuInstructionParametersRamToRamSansPadding {
							...
							sourceId        = 1 + \hubStamp _{i}                             ,
							targetId        = \cn _{i}                                       ,
							sourceOffsetLo  = \modexpMaxByteSizeValue - \locMbsNormalized    ,
							size            = \locMbsNormalized                              ,
		...
		\item[\underline{\underline{Context-row $n^°(i + \prcModexpSuccessUpdatingCallerReturnData)$:}}]
			...
			\[
				\provideReturnData {
					...
					returnDataOffset   = \modexpMaxByteSizeValue  - \locMbsNormalized ,
					returnDataSize     = \locMbsNormalized                            ,
				}
			\]
	\end{description}
