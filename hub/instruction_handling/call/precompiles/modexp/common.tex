...
\end{center}
In other words we will be specifying the common prefix for all \inst{MODEXP} handling, regardless of success or failure.
...
The following three rows serve to extract the three byte size parameters of the \inst{MODEXP} precompile.
...
\begin{description}
	...
	\begin{description}
		...
		The \zkEvm{} is, at long last, in a position to compute the gas cost of the \inst{MODEXP} call, and thereby justify
