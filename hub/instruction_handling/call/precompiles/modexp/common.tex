	...
	\item[\underline{\underline{Miscellaneous row $n^°(i +  \prcModexpFirstXbsRowOffset)$: \locBbs{} extraction row:}}]
		...
		\begin{description}
			...
			\item[\underline{Setting some \locBbs{} related shorthands:}]
				...
				\]
				\saNote{}
				This imposes that $\locBbs{} \equiv 0$ conditions in case of $\locExtractBbs \equiv \false$ i.e. in case of empty call data (size $\leq 0 \cdot \evmWordSize$).
			\item[\underline{Setting \oobMod{} values and defining shorthands:}]
				\[
	...
	\item[\underline{\underline{Miscellaneous row $n^°(i +  \prcModexpSecondXbsRowOffset)$: \locEbs{} extraction row:}}] we impose
		\begin{description}
			...
			\item[\underline{Setting some \locEbs{} related shorthands:}]
				...
				\]
				\saNote{}
				This imposes that $\locEbs{} \equiv 0$ conditions in case of $\locExtractEbs \equiv \false$ i.e. in case of short call data i.e. in case of call data of size $\leq 1 \cdot \evmWordSize$.
			\item[\underline{Setting \oobMod{} values and defining shorthands:}]
				\[
					\setOobInstructionModexpXbs {
						anchorRow  = i                            ,
	...
	\item[\underline{\underline{Miscellaneous row $n^°(i +  \prcModexpThirdXbsRowOffset)$: \locMbs{} extraction row:}}] we impose
		\begin{description}
			...
			\item[\underline{Setting some \locMbs{} related shorthands:}]
				...
				\]
				\saNote{}
				This imposes that $\locMbs{} \equiv 0$ conditions in case of $\locExtractMbs \equiv \false$ i.e. in case of short call data i.e. in case of call data of size $\leq 2 \cdot \evmWordSize$.
			\item[\underline{Setting \oobMod{} values and defining shorthands:}]
				\[
					\setOobInstructionModexpXbs {
						anchorRow  = i                           ,
			...
			\begin{description}
				\item[\underline{Setting lookup flags:}]
					...
					\[
						...
						\end{array} \right.
					\]
					Note that \textbf{by value} we have $\locCallOobForModexpLead \equiv \rOne$.
			...
			\item[\underline{\underline{Miscellaneous row $n^°(i + \prcModexpPricingRowOffset)$:}}] we impose
				\begin{description}
					\item[\underline{Setting lookup flags:}]
						...
						\]
						Note that \textbf{by value} we have $\locCallOobForModexpPricing \equiv \rOne$.
					\item[\underline{Setting \oobMod{} values:}]
