The \inst{BLAKE2f} precompile can fail ``in the \hubMod{}'' or ``in \textsc{ram}.''
...
(\emph{a}) the precompile was provided with insufficient gas to pay for \locBlakeR{} many rounds of \inst{BLAKE2f}
