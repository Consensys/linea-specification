...
\inst{POINT\_EVALUATION},
\inst{BLS\_G1ADD},
\inst{BLS\_G1MSM},
\inst{BLS\_G2ADD},
\inst{BLS\_G2MSM},
\inst{BLS\_PAIRING\_CHECK},
\inst{BLS\_MAP\_FP\_TO\_G1} or
\inst{BLS\_MAP\_FP2\_TO\_G2}.
	...
	\item[\underline{\underline{Miscellaneous row $n^°(i + \prcCommonMiscRowOffset)$:}}]
		...
		\begin{description}
			...
			\item[\underline{Some shorthands for elliptic curve precompiles:}]
				...
				\begin{description}
					...
					\item[\underline{\inst{ECADD}, \inst{ECMUL} and \inst{ECPAIRING} as well as \inst{BLS}-precompile specific:}]
						...
						\]
						\saNote{}
						These bits will be used in the processing of \inst{ECADD}, \inst{ECMUL} and \inst{ECPAIRING}
						...
						\inst{ECADD}, \inst{ECMUL} and \inst{ECPAIRING}
			...
			\item[\underline{Some constraints involving the success bit:}]
				...
				As the names suggest \locMmuWellFormedData{} lets the \hubMod{} module know whether the input data to \inst{ECADD}, \inst{ECMUL} or \inst{ECPAIRING}
