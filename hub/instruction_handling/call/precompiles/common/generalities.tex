			...
			\item[\underline{Some shorthands for elliptic curve precompiles:}]
				...
				\begin{description}
					...
					\item[\underline{\instEcadd{}, \instEcmul{} and \instEcpairing{} as well as \inst{BLS}-precompile specific:}]
						...
						Our definition of the \locWellFormedData{} shorthand may seem blatantly wrong, as it implies in particular that
						$\locWellFormedData \equiv \true$ whenever $\locOobResultEmptyCallData \equiv \true$.
						This would explicitly clash with the specifications of \instPointEvaluation{}, the \inst{BLS}-precompiles and \instPVerify{},
						...
						Thus, the inclusion of \locOobResultEmptyCallData{} as a subcase of \locWellFormedData{} is unproblematic even for these precompiles.
