...
This the \zkEvm{} does through a dedicated \mmuInstMstore{} instruction, see section~(\ref{hub: instruction handling: call: precompiles: ecadd ecmul ecpairing bls: success}).
