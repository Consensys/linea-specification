...
\begin{description}
	\item[\underline{\underline{Shorthands for \inst{ECRECOVER}, \inst{SHA2-256} and \inst{RIPEMD}:}}]
		for
		\[
...
\end{description}
\saNote{}
There are actually two fundamentally distinct ``success'' scenarios for \inst{ECRECOVER}.
...
\begin{description}
	\item[\underline{\underline{Shorthands for \inst{IDENTITY}:}}] the \inst{IDENTITY} precompile requires special care:
		\[
			\left\{ \begin{array}{lcl}
...
\begin{description}
	\item[\underline{\underline{Shorthands for \inst{MODEXP}:}}] the \inst{MODEXP} precompile requires special care:
		\[
			\left\{ \begin{array}{lcl}
	...
	\item[\underline{\underline{Shorthands for \inst{ECADD}, \inst{ECMUL} and \inst{ECPAIRING}:}}]
		...
		\[
			...
			\end{array} \right.
		\]
	\item[\underline{\underline{Shorthands for \inst{BLAKE2f}:}}] the \inst{BLAKE2f} precompile requires special care:
		\[
			\left\{ \begin{array}{lcl}
