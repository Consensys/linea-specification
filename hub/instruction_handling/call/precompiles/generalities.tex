...
\begin{description}
	\item[\underline{Admissible failure scenarios:}]\label{hub: instruction handling: call: precompiles: generalities: admissible failure scenarios}
		we impose thath
		\begin{enumerate}
...
section~(\ref{hub: instruction handling: call: non stack rows for non precompiles}) and more to the point in
