...
\begin{description}
	...
	\item[\underline{Justifying \staticxSH's:}]
		...
		\saNote{}
		The above, seeing as it applies to \textbf{each and every \inst{CALL} instruction}, implies that among (non stack over/underflow) exceptions, \staticxSH{} is dominant and always the primary focus of verification.
