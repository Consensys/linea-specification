\begin{center}
	\boxed{%
		...
		\left\{ \begin{array}{lcl}
			...
			\locStackOogx + \scenCallUnexceptional _{i + \callFirstScenarioRowOffset} & = & 1 \\
		\end{array} \right.
		}
\end{center}
...
\begin{description}
	\item[\underline{First \callerName{} account-row $n^°(i + \callFirstCallerAccountRowOffset)$:}]
		...
		\[
			\left\{ \begin{array}{lcl}
				\accAddressHi _{i + \callFirstCallerAccountRowOffset} & = & \locCurrentAccountAddressHi \\
				\accAddressLo _{i + \callFirstCallerAccountRowOffset} & = & \locCurrentAccountAddressLo \\
