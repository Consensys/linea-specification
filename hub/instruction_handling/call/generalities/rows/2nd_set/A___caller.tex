\item[\underline{\underline{Second \callerName{} account-row $n^°(i + \callSecondCallerAccountRowOffset)$:}}]
	we impose that
	\[
		\left\{ \begin{array}{lcl}
			...
			\multicolumn{3}{l}{\accDontCheckForDelegation        { anchorRow = i, relOffset = \callSecondCallerAccountRowOffset } } \\
			...
			%%%%
			\multicolumn{3}{l}{\accDontTriggerRomLex             { anchorRow = i, relOffset = \callSecondCallerAccountRowOffset } } \\
			\accTrmFlag      _{i + \callSecondCallerAccountRowOffset} & = & 0 \\
			\accRlpAddrFlag  _{i + \callSecondCallerAccountRowOffset} & = & 0 \vspace{2mm} \\
			\multicolumn{3}{l}{\textcolor{solarized-green}{\texttt{<DOM/SUB stamps set below>}}} \\
		\end{array} \right.
	\]
