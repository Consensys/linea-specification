...
\begin{enumerate}
	...
	\item \label{hub: system: hub stamp: entry increments: AUTH case} \If $\txAuth _{i} = 1$ \Then $\hubStamp _{i} = \hubStamp _{i - 1} + \peekAuthorization _{i} + \peekTransaction _{i}$   (\sanityCheck)
