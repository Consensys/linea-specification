...
\begin{enumerate}
        \item \If $\txAuth _{i} = 1$ \Then
                \begin{enumerate}
                        \item $\txAuth _{i + 1} + \txWarm _{i + 1} + \txSkip _{i + 1} + \txInit _{i + 1} = 1$
                        \item $\txAuth _{i + 1} + \peekTransaction _{i} = 1$
                \end{enumerate}
        ...
        \item \If $\txSkip _{i} = 1$ \Then
                \begin{enumerate}
                        \item $\txSkip _{i + 1} + \txAuth _{i + 1} + \txWarm _{i + 1} + \txInit _{i + 1} = 1$
        ...
        \item \If $\txFinl _{i} = 1$ \Then
                \begin{enumerate}
                        \item $\txFinl _{i + 1} + \txAuth _{i + 1} + \txWarm _{i + 1} + \txSkip _{i + 1} + \txInit _{i + 1} = 1$
