\item[\underline{\underline{Recipient account-row n$^°~\bm{(i + \roffTxSkipUserRecipientAccount)}$:}}]
	...
	\[
		\left\{ \begin{array}{lcl}
			...
			\accCheckForDelegation    _{i + \roffTxSkipUserRecipientAccount} & = & \locIsMessageCallTransaction \\
			\accCheckForDelegationNew _{i + \roffTxSkipUserRecipientAccount} & = & 0 \quad (\trash) \\
