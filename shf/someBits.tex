This section constrains the $\someBits$ column. Recall that $\someBits$ should contain the bits of the leading byte of $\argTwo$ and the bits of the least significant byte of $\argOne$.
\begin{enumerate}
