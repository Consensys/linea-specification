The heartbeat of the address trimming module is very simple: the \ct{} column counts from $0$ to $\locCtMaxTrm$ unless $\trmStamp$ is zero, in which case it hovers at $0$.
\begin{enumerate}
	\item $\trmStamp_{0} = 0$
