...
Furthermore when computing a deployment address associated with an invocation of a \inst{CREATE}-type instruction the \rlpAddrMod{} module is called, too, to trim down the raw \texttt{KECCAK} hash.
